  ...
  return (
    ...
    <header>
      <nav
        className={`${
          state
            ? " top-0   shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none"
            : ""
        } pb-5 md:text-sm h-full`} 
      >
    ...
    <section className="flex flex-col md:flex-row items-center justify-center">
      <div className="px-4 py-10 gap-24 text-gray-600 overflow-hidden md:px-24 md:flex relative h-full"> {/* Added h-full class for full height background */}
        <div className="flex-none space-y-10 max-w-xl">
          ...
          <div className="flex items-center justify-center gap-x-3 sm:text-sm mt-4 md:justify-start">
            <Link to="/section">
              <a
                href="#"
                className="flex items-center justify-center gap-x-1 py-4 px-10 text-white font-medium bg-blue-700 duration-150 hover:bg-gray-400 active:bg-gray-900 rounded-full md:inline-flex relative z-10" 
              >
                Get started
                <svg
                  xmlns="http://www.w3.org/2000/svg"
